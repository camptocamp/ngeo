 ...
 * @property {Array.<!string>} [preset_layer_filter] Name of the layer (data source) that should be toggled in the filter tool
 ...
 * @property {Array.<string>} [copy_to] Names of layers on which the geometry can be copied to (in the edition mode).
 ...
 * @property {Array.<string>} [directedFilterAttributes] List of attribute names which should have rules already ready when using
 ...
 * @property {Array.<string>} [enumeratedAttributes] List of attribute names which have enumerated attribute values (for filters
 ...
 * @property {boolean} [geometry_validation=false] Whether geometries must be validated by PostgreSQL on edition. For WMS layers.
 * @property {string} [iconUrl] The URL of the icon to display in the layer tree. For WMS and WMTS layers.
 * @property {string} identifierAttributeField The field used in the 'display query window' as feature title. For WMS layers.
 * @property {boolean} [isChecked=false] Is the layer checked by default. For WMS and WMTS layers.
 * @property {boolean} [isExpanded=false] Whether the layer group is expanded by default. For layer groups (only).
 * @property {boolean} [printNativeAngle=true] Whether the print should rotate the symbols. For layer groups (only).
 * @property {boolean} [isLegendExpanded=false] Whether the legend is expanded by default. For WMS and WMTS layers.
 * @property {string} [lastUpdateDateColumn] 'Date' column that will be automatically updated after editing an element. For WMS layers.
 * @property {string} [lastUpdateUserColumn] 'User' column that will be automatically updated after editing an element. For WMS layers.
 * @property {boolean} [legend=false] Display the legend of this layers. For WMS and WMTS layers.
 * @property {string} [legendImage] The URL to the image used as a legend in the layer tree. For WMS and WMTS layers.
 ...
 * @property {number} [opacity=1.0] Layer opacity. 1.0 means fuly visible, 0 means invisible, For WMS and WMTS layers.
 * @property {string} [printLayers] A WMS layer that will be used instead of the WMTS layers in the print. Used
 * to increase quality of printed WMTS layers. For WMTS layers.
 * @property {string} [queryLayers] The WMS layers used as references to query the WMTS layers. For WMTS layers.
 ...
 * @property {GmfSnappingConfig} [snappingConfig] The snapping configuration for the leaf. If set, the leaf's layer is
