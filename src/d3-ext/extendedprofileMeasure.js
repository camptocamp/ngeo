...
ngeo.extendedProfile.measure.measureHeight = function() {
  ...
  const tolerance = 2;
  const sx = ngeo.extendedProfile.options.profileConfig.scaleX;
  const sy = ngeo.extendedProfile.options.profileConfig.scaleY;
  const pointSize = 3;
  const p = ngeo.extendedProfile.plot2canvas.getClosestPoint(ngeo.extendedProfile.loader.profilePoints, canvasCoordinates[0], canvasCoordinates[1], tolerance);
  ...
  const dH = ngeo.extendedProfile.measure.profileMeasure.pEnd.altitude - ngeo.extendedProfile.measure.profileMeasure.pStart.altitude;
  const dD = ngeo.extendedProfile.measure.profileMeasure.pEnd.distance - ngeo.extendedProfile.measure.profileMeasure.pStart.distance;
