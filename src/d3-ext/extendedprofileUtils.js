...
***/
let interpolatePoint = function (d, segment) {
...
***/
let clipLineByMeasure = function (dLeft, dRight) {
...
let downloadDataUrlFromJavascript = function(filename, dataUrl) {
...
***/
let exportToImageFile= function (format) {
...
let getPointsInProfileAsCSV = function (profilePoints) {
